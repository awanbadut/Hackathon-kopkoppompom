...
export default function ERatTab({
 ...
 return (
 <div key={agenda.id} className="p-5 bg-stone-50 border border-stone-200 rounded-2xl space-y-4">
 ...
 agenda.status === 'aktif' ? 'bg-[#F1F7EA] text-[#3F6B24] border border-[#C7DDAE]' : 'bg-stone-200 text-stone-800'
 }`}>
 {agenda.status}
 </span>
 </div>
