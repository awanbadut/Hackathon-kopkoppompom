  ...
  const renderNavLinks = () => {
    return (
      <div className="space-y-1.5">
        <button
          onClick={() => { handleTabChange('overview'); closeMenu(); }}
        ...
        {['pengurus', 'ketua'].includes(session.role) && (
          <button
            onClick={() => { handleTabChange('transactions'); closeMenu(); }}
            className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer border ${
        ...
        {['pengurus', 'ketua'].includes(session.role) && (
          <button
            onClick={() => { handleTabChange('member_savings'); closeMenu(); }}
            className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer border ${
        ...
        {['pengurus', 'ketua'].includes(session.role) && (
          <button
            onClick={() => { handleTabChange('approvals'); closeMenu(); }}
            className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer border ${
              activeTab === 'approvals'
                ? 'bg-[#548C2F] text-white border-[#F9A620]/30 shadow-md'
                : 'bg-transparent text-stone-300 hover:text-white hover:bg-white/5 border-transparent'
        ...
        {['pengurus', 'ketua', 'pendamping'].includes(session.role) && (
          <button
            onClick={() => { handleTabChange('compliance'); closeMenu(); }}
            className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer border ${
        ...
        <button
          onClick={() => { handleTabChange('financials'); closeMenu(); }}
          className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer border ${
        ...
        <button
          onClick={() => { handleTabChange('e_rat'); closeMenu(); }}
          className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer border ${
            activeTab === 'e_rat'
              ? 'bg-[#548C2F] text-white border-[#F9A620]/30 shadow-md'
              : 'bg-transparent text-stone-300 hover:text-white hover:bg-white/5 border-transparent'
        ...
        <button
          onClick={() => { handleTabChange('aspirations'); closeMenu(); }}
          className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer border ${
        ...
        <button
          onClick={() => { handleTabChange('learning'); closeMenu(); }}
          className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer border ${
            activeTab === 'learning'
              ? 'bg-[#548C2F] text-white border-[#F9A620]/30 shadow-md'
              : 'bg-transparent text-stone-300 hover:text-white hover:bg-white/5 border-transparent'
        ...
        <button
          onClick={() => { handleTabChange('rewards'); closeMenu(); }}
          className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer border ${
            activeTab === 'rewards'
              ? 'bg-[#548C2F] text-white border-[#F9A620]/30 shadow-md'
              : 'bg-transparent text-stone-300 hover:text-white hover:bg-white/5 border-transparent'
        ...
        <button
          onClick={() => { handleTabChange('ai_assistant'); closeMenu(); }}
          className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer border ${
        ...
        <button
          onClick={() => { handleTabChange('microsite'); closeMenu(); }}
          className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer border ${
            activeTab === 'microsite'
              ? 'bg-[#548C2F] text-white border-[#F9A620]/30 shadow-md'
              : 'bg-transparent text-stone-300 hover:text-white hover:bg-white/5 border-transparent'
        ...
        {['pengurus', 'ketua'].includes(session.role) && (
          <button
            onClick={() => { handleTabChange('proposals'); closeMenu(); }}
            className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider transition-all cursor-pointer border ${
              activeTab === 'proposals'
                ? 'bg-[#548C2F] text-white border-[#F9A620]/30 shadow-md'
                : 'bg-transparent text-stone-300 hover:text-white hover:bg-white/5 border-transparent'
